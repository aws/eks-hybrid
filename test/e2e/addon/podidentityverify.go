...
func (v VerifyPodIdentityAddon) Run(ctx context.Context) error {
	...
	patchStr := `{"spec":{"template":{"spec":{"volumes":[{"name":"aws-credentials","hostPath":{"path":"/var/eks-hybrid/.aws","type":"Directory"}}],"containers":[{"name": "eks-pod-identity-agent","securityContext": {"privileged": true}}]}}}}`
