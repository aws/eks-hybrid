...
func (n *Network) CreateRoutesForNode(ctx context.Context, instance ec2.Instance) error {
	node, err := kubernetes.GetNodeByInternalIP(ctx, n.K8s, instance.IP)
	if err != nil {
	...
	if err := n.addRoutesForCIDRs(ctx, instance, podCIDRs); err != nil {
