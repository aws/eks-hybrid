...
// NodeVersioner defines how to get the nodeadm version from a node
...
// BottlerocketVersioner implements NodeVersioner for Bottlerocket
type BottlerocketVersioner struct{}

func (b *BottlerocketVersioner) GetVersion(ctx context.Context, runner commands.RemoteCommandRunner, instanceIP string) (string, error) {
	// Bottlerocket doesn't use nodeadm in the same way
	return "N/A", nil
}

// GenericLinuxVersioner implements NodeVersioner for generic Linux
type GenericLinuxVersioner struct{}

func (g *GenericLinuxVersioner) GetVersion(ctx context.Context, runner commands.RemoteCommandRunner, instanceIP string) (string, error) {
...
// NewNodeVersioner returns the appropriate NodeVersioner for the given OS
func NewNodeVersioner(osName string) NodeVersioner {
	if os.IsBottlerocket(osName) {
		return &BottlerocketVersioner{}
	}
	return &GenericLinuxVersioner{}
}
